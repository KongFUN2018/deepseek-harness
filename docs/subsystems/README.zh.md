...
| [workbench.md](workbench.md) | 跨会话注意力收件箱：`WorkbenchSnapshot`、逐条结果的 B 类批量确认、C 类决策、`workbench/attention-updated` 推送 |
| [task-flow.md](task-flow.md) | 任务流程工作台域：recipe 身份/revision、task 投影、journal、deliverable 版本 |
