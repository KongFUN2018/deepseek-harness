# Workbench attention inbox

English | [中文](workbench.zh.md)

The cross-session attention inbox of [dsh-workbench-host](../../packages/task-flow/workbench-host): B-class confirmation batches, C-class single decisions, and compare-and-set revisions, consumed by the browser workbench through the Typert gateway. The package README owns the Remote method contracts; this page records the wire types from [`packages/task-flow/workbench-host/src/types.ts`](../../packages/task-flow/workbench-host/src/types.ts).
