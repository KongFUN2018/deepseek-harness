...
- `@deepseek-ai/dsh-deliverable-minimal` — 需要 `storageDomain`（[`packages/task-flow/deliverable-minimal/src/index.ts`](../packages/task-flow/deliverable-minimal/src/index.ts)）
