...
- `@deepseek-ai/dsh-client-ui-workbench-drawer`（[`packages/task-flow/client-ui-workbench-drawer/src/index.ts`](../packages/task-flow/client-ui-workbench-drawer/src/index.ts)）
...
- `@deepseek-ai/dsh-task` — 抽象 `TaskHandle`（[`packages/task-flow/task/src/index.ts`](../packages/task-flow/task/src/index.ts)）
