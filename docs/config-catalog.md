...
- `@deepseek-ai/dsh-deliverable-minimal` — requires `storageDomain` ([`packages/task-flow/deliverable-minimal/src/index.ts`](../packages/task-flow/deliverable-minimal/src/index.ts))
