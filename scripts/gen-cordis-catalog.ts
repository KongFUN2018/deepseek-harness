...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  recipes: 'task-flow.md',
  tasks: 'task-flow.md',
  digest: 'task-flow.md',
  metrics: 'task-flow.md',
  workbenchHost: 'workbench.md',
  workbenchJournal: 'task-flow.md',
  deliverables: 'task-flow.md',
  editLock: 'task-flow.md',
  impactPropagation: 'task-flow.md',
  recipeEngine: 'task-flow.md',
  recipeMultiphase: 'task-flow.md',
  clarifications: 'task-flow.md',
  gate: 'task-flow.md',
  attention: 'task-flow.md',
  workbenchHostStream: 'task-flow.md',
  rewind: 'task-flow.md',
  budget: 'task-flow.md',
  reviewPolicy: 'task-flow.md',
...
export const EVENT_SCOPE_PAGE: Record<string, string> = {
  ...
  'task': 'task-flow.md',
  'task-run': 'task-flow.md',
  'phase-run': 'task-flow.md',
  'gate-check': 'task-flow.md',
}
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  WorkbenchAttentionUpdate: 'workbench.md',
  WorkbenchSnapshot: 'workbench.md',
  BatchConfirmRequest: 'workbench.md',
  BatchConfirmResponse: 'workbench.md',
  ResolveDecisionRequest: 'workbench.md',
  ResolveDecisionResponse: 'workbench.md',
  InvalidateItemRequest: 'workbench.md',
  InvalidateItemResponse: 'workbench.md',
  RecipeIdentity: 'task-flow.md',
  RecipePayload: 'task-flow.md',
  RecipeRevision: 'task-flow.md',
  TaskRecord: 'task-flow.md',
  TaskRunRecord: 'task-flow.md',
  PhaseRunRecord: 'task-flow.md',
  PhaseSubmission: 'task-flow.md',
  PinnedRecipe: 'task-flow.md',
  TaskMutationContext: 'task-flow.md',
  GateCheckResult: 'task-flow.md',
  TaskCreateConfirmResult: 'task-flow.md',
  TaskSeedContent: 'task-flow.md',
  TaskSeedPoint: 'task-flow.md',
  TaskDigest: 'task-flow.md',
  WorkbenchMetrics: 'task-flow.md',
  TaskMetrics: 'task-flow.md',
  DigestRunBranch: 'task-flow.md',
  DigestTimelineEntry: 'task-flow.md',
  DigestPhaseSummary: 'task-flow.md',
  DigestDecision: 'task-flow.md',
  DigestDeliverableState: 'task-flow.md',
  GatePassRate: 'task-flow.md',
  ThroughputDay: 'task-flow.md',
  PhaseDuration: 'task-flow.md',
  SubmissionEnvironmentFacts: 'task-flow.md',
  JournalFact: 'task-flow.md',
  JournalFactInput: 'task-flow.md',
  JournalCheckpoint: 'task-flow.md',
  DeliverableId: 'task-flow.md',
  DeliverableVersionId: 'task-flow.md',
  DeliverableVersion: 'task-flow.md',
  DeliverableVersionState: 'task-flow.md',
  InvalidateDownstreamResult: 'task-flow.md',
  PhaseExecutor: 'task-flow.md',
  PhaseAssignment: 'task-flow.md',
  PhaseOutcome: 'task-flow.md',
  TaskId: 'task-flow.md',
  PhaseRunId: 'task-flow.md',
  DeliverableVersionRef: 'task-flow.md',
  ImpactSnapshot: 'task-flow.md',
  ImpactApplication: 'task-flow.md',
  EditLease: 'task-flow.md',
  ClarificationRequest: 'task-flow.md',
  ClarificationQuestionId: 'task-flow.md',
  ClarificationQuestionInput: 'task-flow.md',
  Question: 'task-flow.md',
  Answer: 'task-flow.md',
  AttentionItem: 'task-flow.md',
  AttentionItemId: 'task-flow.md',
  AttentionItemKind: 'task-flow.md',
  AttentionItemState: 'task-flow.md',
  CreateItemInput: 'task-flow.md',
  ConfirmTarget: 'task-flow.md',
  DecisionResult: 'task-flow.md',
  ConfirmResult: 'task-flow.md',
  InvalidateResult: 'task-flow.md',
  IncrementalPage: 'task-flow.md',
  AttentionStreamEvent: 'task-flow.md',
  AttentionStreamOperation: 'task-flow.md',
  BudgetRecordId: 'task-flow.md',
  BudgetDimension: 'task-flow.md',
  BudgetLimits: 'task-flow.md',
  BudgetUsage: 'task-flow.md',
  BudgetSpent: 'task-flow.md',
  BudgetRecord: 'task-flow.md',
  RewindPreview: 'task-flow.md',
  RewindApplication: 'task-flow.md',
  TrustTier: 'task-flow.md',
  ReviewPolicyRecord: 'task-flow.md',
  BreakerCounter: 'task-flow.md',
