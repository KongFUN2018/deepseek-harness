...
import type { TaskCreateInput, TaskCreateProposal } from './types.ts'

export type { TaskCreateInput, TaskCreateProposal } from './types.ts'

declare module '@deepseek-ai/cordis' {
  interface Context {
    recipes: import('@deepseek-ai/dsh-recipe').default
  }
}
...
function proposalOf(ctx: Context, input: TaskCreateInput): TaskCreateProposal {
