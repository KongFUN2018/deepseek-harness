...
export default defineConfig([
  {
    ...
    deps: { neverBundle: ['@deepseek-ai/dsh-task', '@deepseek-ai/dsh-attention', '@deepseek-ai/dsh-workbench-host', '@deepseek-ai/dsh-deliverable-local', '@deepseek-ai/dsh-workbench-journal', '@deepseek-ai/dsh-typert-protocol', '@deepseek-ai/dsh-invariants', '@deepseek-ai/dsh-brand'] },
  },
  {
