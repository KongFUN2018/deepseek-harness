import type { AttentionItemView, AttentionItemStatus } from '@deepseek-ai/dsh-workbench-host/types'
...
// Type-only: pulls the drawer shell's SlotMap merge (the 'workbench.drawer.clarifications' seat).
