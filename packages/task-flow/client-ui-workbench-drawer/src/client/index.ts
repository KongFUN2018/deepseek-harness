/**
 * Workbench drawer plugin, browser half: one `sidebar.entry` trigger button
 * (prominent, accent-styled) and one `shell.overlay` drawer panel (right-side,
 ...
 * controller, and the two register entries — the sidebar trigger and the
...
export function apply(ctx: ClientContext): void {
  ...
  // Sidebar trigger: a same-level side-bar member, prominent and accent-styled.
