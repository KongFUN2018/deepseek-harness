...
// Type-only: pulls ui-sidebar's SlotMap merge (the 'sidebar.entry' entry and
...
/** The trigger's props: sidebar.entry runtime/owner share + shared store + locale. */
export type WorkbenchTriggerProps =
  PropsRuntime<'sidebar.entry'>
 ...
 * @param props - composed slot props for the 'sidebar.entry' hole.
 * @returns the trigger button.
 */
export function WorkbenchTrigger(props: WorkbenchTriggerProps) {
  const { t, wide, expandSidebar, useStore, actions, useBadge } = props
