...
import type { DeliverableVersionRef, PhaseRunId, SubmissionId } from '@deepseek-ai/dsh-task/types'
...
export type DeliverableFactKind =
  | 'deliverable/version-saved'
  | 'deliverable/version-staled'
  | 'deliverable/impact-snapshotted'
