...
| [`task-flow/`](task-flow/README.md) | Cross-session task-flow workbench: recipe-driven task execution, gate checks, and the attention channel | Product — in development on branch `product/workbench` |
