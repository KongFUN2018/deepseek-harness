...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-workbench-drawer WorkbenchDrawer id \'workbench-drawer\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    keyDomain: 'open: any string the owner dispatches (no compile-time key set), already taken: ask_user_question, bash, cordis_define, cordis_run, cordis_stop, cordis_undefine, edit, glob, grep, read, skill, task_create, todo_write, web_fetch, web_search, write',
    hookContext: '',
    slotInject: '',
    ...
    occupants: [
      ...
      'client-ui-task-create-confirm TaskCreateProposalView key \'task_create\'',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'The task-detail tab body of the workbench drawer.',
    doc: 'The task-detail tab body of the workbench drawer. Declared by the\ndrawer shell\'s `shell.overlay` entry; the task-detail package registers\nthe per-task projection view here.',
    registerOptions: [],
    ownerProps: [
    ...
    declaredBy: 'an entry in \'shell.overlay\' (client-ui-workbench-drawer), so it exists while that entry is mounted',
    occupants: [
      'client-ui-task-detail TaskDetailAction',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'workbench.drawer.detail\', () => ctx.slots.register(\n      { name: \'workbench.drawer.detail\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/task-flow/client-ui-workbench-drawer/src/client/slots.ts:27',
  },
  {
    key: 'workbench.drawer.inbox',
    kind: 'single',
    scope: 'root',
    summary: 'The attention-inbox tab body of the workbench drawer.',
    doc: 'The attention-inbox tab body of the workbench drawer. Declared by the\ndrawer shell\'s `shell.overlay` entry; the attention-inbox package\nregisters the B batch-confirm list and C decision cards here.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'an entry in \'shell.overlay\' (client-ui-workbench-drawer), so it exists while that entry is mounted',
    occupants: [
      'client-ui-attention-inbox AttentionInboxAction',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'workbench.drawer.inbox\', () => ctx.slots.register(\n      { name: \'workbench.drawer.inbox\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/task-flow/client-ui-workbench-drawer/src/client/slots.ts:21',
  },
  {
    key: 'workbench.drawer.tasks',
    kind: 'single',
    scope: 'root',
    summary: 'The task-list tab body of the workbench drawer.',
    ...
    declaredBy: 'an entry in \'shell.overlay\' (client-ui-workbench-drawer), so it exists while that entry is mounted',
    occupants: [
      'client-ui-task-board TaskBoardAction',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'workbench.drawer.tasks\', () => ctx.slots.register(\n      { name: \'workbench.drawer.tasks\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/task-flow/client-ui-workbench-drawer/src/client/slots.ts:15',
  },
]
/* jscpd:ignore-end */
